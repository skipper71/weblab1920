                                ...
                                <div class="col-md-9 col-md-push-3">
                                    ...
                                    <div class="books-gird">
                                        <ul>
                                            ...
                                            if (isset($genere)){
                                                if (isset($titolo)){
                                                    $query = "SELECT * FROM libri_matteo WHERE genere='".$genere."' AND titolo LIKE '%".$titolo."%'";                                                    
                                                } else {
                                                    $query = "SELECT * FROM libri_matteo WHERE genere='".$genere."'";
                                                }                                                
                                            } elseif (isset($titolo) && !isset($genere)){
                                                $query = "SELECT * FROM libri_matteo WHERE titolo LIKE '%".$titolo."%'";
                                            } else {
                                                $query = "SELECT * FROM libri_matteo ORDER BY titolo DESC";
                                            }
                                                    ...
                                                    <div class="single-book-box">
                                                        <div class="post-detail">
                                                            ...
                                                            <header class="entry-header">
                                                                <h3 class="entry-title"><a href="books-media-detail-v1.html"><?php echo($row['titolo'])?></a></h3>
                                                                <ul>
                                                            ...
                                                            <div class="entry-content">
                                                                <p><?php echo($row['riassunto_trama'])?></p>
                                                            </div>
