                    ...
                    <div class="books-full-width">
                        <div class="container">
                            ...
                            <div class="booksmedia-fullwidth">
                                <ul>
                                    <?php
                                    $stmt = $pdo->query("SELECT * FROM libri_jasmin LIMIT 10");
                                    ...
                                    <li>
                                        ...
                                        <figure>
                                            ...
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.html"><?php echo ($row["Titel"]);?></a></h4>
                                                    <p><strong>Author:</strong>  <?php echo ($row["Autor"]);?></p>
