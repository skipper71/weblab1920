                    ...
                    <div class="books-full-width">
                        <div class="container">
                            ...
                            <div class="filter-buttons">
                                <div class="filter btn" data-filter="all">Title</div>
                                <div class="filter btn" data-filter=".adults">Author</div>
                                <div class="filter btn" data-filter=".kids-teens">Popularity</div>
                                <div class="filter btn" data-filter=".video">Rating</div>
                                <div class="filter btn" data-filter=".audio">Newness</div>
                            </div>
                            ...
                            <div class="booksmedia-fullwidth">
                                <ul>
                                    <?php
                                    $stmr = $pdo->query("SELECT * FROM libri_jasmin WHERE ISBN='978-1-4088-5567-6'");
                                    ...
                                    <li>
                                        ...
                                        <figure>
                                            ...
                                            <figcaption>
                                                <header>
                                                    <h4><a href="books-media-detail-v2.html"><?php echo ($row["Title"]);?></a></h4>
                                                    <p><strong>Author:</strong>  <?php echo ($row["Author"]);?></p>
                                                    <p><strong>ISBN:</strong> <?php echo ($row["ISBN"]);?></p>
                                                </header>
                                                <p><?php echo ($row["Inhalt"]);?></a></p>
                                                <div class="actions">
                                                    <ul>
                                                        <li>
                                       ...
                                       <?php
                                    $stmr = $pdo->query("SELECT * FROM libri_jasmin WHERE ISBN='978-3-570-40350-1'");
                                    while ($row = $stmt->fetch())
                                    {
                                        ?>
                                    <li>
                                    ...
                                    <?php
                                    $stmr = $pdo->query("SELECT * FROM libri_jasmin WHERE ISBN='978-88-395-3397-5'");
                                    while ($row = $stmt->fetch())
                                    {
                                        ?>
                                    <li>
                                    ...
                                    <?php
                                    $stmr = $pdo->query("SELECT * FROM libri_jasmin WHERE ISBN='978-3423128872'");
                                    while ($row = $stmt->fetch())
                                    {
                                        ?>
                                    <li>
                                    ...
                                    <?php
                                    $stmr = $pdo->query("SELECT * FROM libri_jasmin WHERE ISBN='??'");
                                    while ($row = $stmt->fetch())
                                    {
                                        ?>
                                    <li>
